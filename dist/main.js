...
try {
    ...
    const newChangelog = insertChangelog(changelog || defaultChangelog, result.changelog);
    ...
    if (latest) {
        await promises.writeFile(typeof latest === "string" ? latest : "CHANGELOG_latest.md", result.changelog);
    }
}
catch (err) {
